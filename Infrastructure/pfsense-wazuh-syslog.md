...
Dengan ini, semua infrastructure monitoring lab udah lengkap: 5 endpoint agent (Ubuntu Host, Win7, WinXP, WIN AD, Web-Server) + pfSense syslog + Sysmon di WIN AD & Win7.
